...
<form enctype="multipart/form-data" method="POST" target="postYama" name="yamaForm" id="yamaForm" action="http://newtest.ukryama.com/holes/smallhole" onSubmit="validate(this);return false;">
<!-- Персональные данные -->
<table id="addyama">
...
<td rowspan=2><a href="http://ukryama.com/"><img width="70px" src="http://newtest.ukryama.com/images/logo.png"></a></td></tr>
<tr><td colspan=2>
<!-- Тип дефекта -->
